...
<!--          <ContentSlot :use="$slots.default" :value="data.article" />-->
...
.article {
  @apply col-span-full md:col-span-6 md:col-start-1 md:row-start-1 prose prose-invert w-full p-4 max-w-3xl m-auto;
}
</style>
